...
export class UserComponent {
  constructor() {
    ...
    //event delegation
    this.r_header = document.getElementsByClassName("js-user-header-menu")[0];
    this.header = document.getElementsByClassName("js-user-header-menu")[1];
    this.user_menu = document.getElementsByClassName("js-user-menu")[0];
  ...
  addCafe(callback, self) {
    if (this.add_cafe_btn !== undefined) {
      this.add_cafe_btn.addEventListener("click", (e) => {
        e.preventDefault();

        let userData = new FormData(this.add_cafe_form);
  ...
  settings(callback, self) {
    if (this.settings_btn !== undefined) {
      this.settings_btn.addEventListener("click", (e) => {
        e.preventDefault();

        let userData = new FormData(this.settings_form);
  ...
  addReview(callback, self) {
    if (this.add_review_btn !== undefined) {
      this.add_review_btn.addEventListener("click", (e) => {
        e.preventDefault();

        let userData = new FormData(this.review_form);
  ...
  headerMenu(callback, self) {
    ...
    if (this.r_header !== undefined) {
      this.r_header.addEventListener("click", (e) => {
        e.preventDefault();
  ...
  userMenu(callback, self) {
    ...
    if (this.user_menu !== undefined) {
      this.user_menu.addEventListener("click", (e) => {
        e.preventDefault();
